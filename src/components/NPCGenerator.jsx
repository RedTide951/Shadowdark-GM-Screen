    ...
    return (
        <Card className="cardClass">
            <Grid container spacing={2}>
                ...
                <Grid size={12}>
                    <Button variant="contained" onClick={generateNPC}>Generate</Button>
                </Grid>
                <Grid size={3}>
                    <Typography className="attributeDisplay" variant="result">Name</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="resultDisplay" variant="result">{npc.name}</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="attributeDisplay" variant="result">Ancestry</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="resultDisplay" variant="result">{npc.ancestry}</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="attributeDisplay" variant="result">Alignment</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="resultDisplay" variant="result">{npc.alignment}</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="attributeDisplay" variant="result">Age</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="resultDisplay" variant="result">{npc.age}</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="attributeDisplay" variant="result">Wealth</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="resultDisplay" variant="result">{npc.wealth}</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="attributeDisplay" variant="result">Appearance</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="resultDisplay" variant="result">{npc.appearance}</Typography>
                </Grid>
                <Grid size={3}>
                    <Typography className="attributeDisplay" variant="result">Secret</Typography>
                </Grid>
                <Grid size={9}>
                    <Typography className="resultDisplay" variant="result">{npc.secret}</Typography>
                </Grid>
            </Grid>
        </Card >
    );
